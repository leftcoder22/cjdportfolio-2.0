...
export default function About({}: Props) {
  return (
    ...
    viewport={{ once: true}}
    src='https://scontent-lga3-1.xx.fbcdn.net/v/t1.6435-9/128424983_10157697160458359_2704060518537840692_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=730e14&_nc_ohc=_qvMrtq83ZQAX8tffc1&_nc_ht=scontent-lga3-1.xx&oh=00_AfCccCMtHFWXsjmmtlXRr6V1_YfRwDiSPRWABafKoCY9pQ&oe=63AC7B72'
